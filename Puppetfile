mod 'profile',
    :git => 'git@forge.softwareheritage.org:/diffusion/SPPROF/swh-profile.git'

mod 'role',
    :git => 'git@forge.softwareheritage.org:/diffusion/SPROLE/swh-role.git'
...
mod 'icingaweb2',
    :git => 'git@forge.softwareheritage.org:/source/puppet-icinga-icingaweb2.git',
    :ref => 'v2.0.0'
...
mod 'puppetdb',
    :git => 'git@forge.softwareheritage.org:/source/puppet-puppetlabs-puppetdb.git',
    :ref => '6.0.1'
...
mod 'varnish',
    :git => 'git@forge.softwareheritage.org:/source/puppet-claranet-varnish.git',
    :ref => '4.1.6'
