class profile::elasticsearch::indices_curator {
  ...
  $intermediate_lifecycle_indices = lookup('elasticsearch::curator::intermediate_lifecycle_indices')
  $short_lifecycle_indices = lookup('elasticsearch::curator::short_lifecycle_indices')
  $long_intermediate_lifecycle_indices = $long_lifecycle_indices + $intermediate_lifecycle_indices
  $long_retention = lookup('elasticsearch::curator::long_retention')
  $intermediate_retention = lookup('elasticsearch::curator::intermediate_retention')
  $short_retention = lookup('elasticsearch::curator::short_retention')
  $long_intermediate_closing_delay = lookup('elasticsearch::curator::long_intermediate_closing_delay')
